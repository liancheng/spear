 ...
 * }}}
 *
 * @define tree [[scraper.trees.TreeNode tree]]
 * @define trees [[scraper.trees.TreeNode trees]]
 *
 * @define node [[scraper.trees.TreeNode tree node]]
 * @define nodes [[scraper.trees.TreeNode tree nodes]]
 *
