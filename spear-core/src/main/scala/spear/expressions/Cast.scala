...
import spear.Row
import spear.exceptions.{ImplicitCastException, TypeCastException}
import spear.expressions.Cast.{buildCast, castable}
...
object Cast {
  ...
  private[spear] val booleanTrueStrings = Set("yes", "y", "true", "t", "on")

  private[spear] val booleanFalseStrings = Set("no", "n", "false", "f", "off")

  private[spear] val booleanStrings = booleanTrueStrings ++ booleanFalseStrings
